...
import "./traits/TransferNFTHelper.sol";
import "./MarketRegistry.sol";


contract Aggregator is TransferNFTHelper, Ownable2Step, ReentrancyGuard {
    ...
    constructor(address _marketRegistry, address _converter, address _guardian, address _feeRecipient) {
        ...
        affiliates.push(AffiliateDetails(feeRecipient, true));
    }
    ...
    function _collectFee(uint256[2] memory feeDetails) internal {
        ...
        if (feeDetails[1] > 0) {
            ...
            affiliateDetails.isActive
                ...
                : _transferEth(feeRecipient, feeDetails[1]);
        }
    }
    ...
    function _transferFromHelper(
        ...
        TransferNFTHelper.ERC721Details[] memory erc721Details,
